              ...
              {tasks.map((task) => (
                <div key={task.id} className="bg-[#FFDAB3]/10 rounded-2xl border border-[#FFDAB3]/30 hover:border-[#FFDAB3]/50 transition flex flex-col">
                  <div className="px-2 py-2 border-b border-[#FFDAB3]/20">
                    <div className="flex items-center justify-between px-4 py-2 bg-[#1B211A] rounded-xl border border-[#FFDAB3]/25">
                  ...
                  <div className="px-4 py-3 flex flex-col gap-2 text-sm text-[#F8F8F2]/80 flex-1">
                    ...
                    <div className="flex justify-between">
                      <span>Created</span>
                      <span className="text-[#FFDAB3]"> <DateConversion convertDate={task.createdAt} /> </span>
                    </div>

                    <div className="flex justify-between">
                      <span>Due</span>
                      <span className="text-[#FFDAB3]"> <DateConversion convertDate={task.dueDate} /> </span>
                    </div>
